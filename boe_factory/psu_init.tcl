...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00A4 0x01003F07 0x01000203
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01011E02
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x0092809D
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x4708010E
    ...
    mask_write 0XFD0701A4 0x00FF00FF 0x00A9007E
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000A04
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x2C096010
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0xA9801460
    ...
    mask_write 0XFD080118 0xFFFFFFFF 0x00080300
...
set psu_peripherals_powerdwn_data {
    ...
    mask_write 0XFFD80218 0x0000000C 0x0000000C
		# : POWER DOWN TRIGGER
    ...
    mask_write 0XFFD80220 0x0000000C 0x0000000C
}
